...
- Exploración y obtención de datos de diversa índole, contemplando las diferentes fuentes posibles: OCR , web sacraping, prensa digital, redes sociales, Youtube, APIs. 
...
- Hacerse una pregunta inicial (luego podrá variar o ampliarse)
- Identificar una fuente textual para responderla (y en qué soporte está)
...
- Para realizar estas tareas hay funciones básicas de _R base_. En el curso veremos las funciones que se incluyen en la librería [stringr](https://stringr.tidyverse.org/) de Tidyverse. 

- [Procesamiento de cadenas](http://rafalab.dfci.harvard.edu/dslibro/procesamiento-de-cadenas.html)
