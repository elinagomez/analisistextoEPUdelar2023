...
- [Espacio virtual EVA](https://eva.fcs.udelar.edu.uy/course/view.php?id=1133)

- Requisito un 80% de asistencia. 
...
1. Crear un proyecto que se llame _CursoRAT2024_ (.Rproj)
2. Crear una carpeta que se llame _Material_ y otra _Datos_
3. Cargar en la carpeta Datos, la base world en RData que está en EVA.
